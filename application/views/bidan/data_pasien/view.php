  ...
  <script>
    $('document').ready(function(){
      ...
      table = $('#t_pasien').DataTable({
          ...
          "ajax": {
              "url": "bidan_data_pasien/get_data_pasien",
              "type": "POST"
          },
          "columnDefs": [
          {
      ...
      $("#simpan_account").click(function(e) {
        ...
        if($('#form_account').parsley().validate()){
          ...
          $.ajax({
            type    : 'POST',
            data    : form,
            url     : "bidan_data_pasien/simpan_account",
            success : function(data) {
      ...
      $('#t_pasien').on( 'click', 'tr .edit', function () {
          ...
          $.ajax({
            type    : 'POST',
            data    : {id:id},
            url     : "bidan_data_pasien/cari_pasien",
            dataType: 'json',
            success : function(data) {
        ...
        $('#t_pasien').on( 'click', 'tr .account', function () {
            ...
            $.ajax({
              type    : 'POST',
              data    : {id:id},
              url     : "bidan_data_pasien/cari_account",
              dataType: 'json',
              success : function(data) {
