...
<div class="clearfix">
  ...
  <div class="pull-right">
    <a href="#" class="btn btn-danger scroll-click" rel="content-y" onclick="loadPage('bidan_data_kohort');" role="button"><i class="fa fa-times-circle"></i> Close</a>
  </div>
</div>
<form name="form" id="form" enctype="multipart/form-data">
  ...
  <div class="btn-list text-center">
    <button type="button" class="btn btn-success" onclick="loadPage('bidan_data_kohort/add');" ><i class="fa fa-plus-circle"></i> Baru</button>
		<button type="button" class="btn btn-danger" onclick="loadPage('bidan_data_kohort');"><i class="fa fa-times-circle"></i> Close</button>
...
<script type="text/javascript">
      ...
      $("#cari").click(function(e) {
        ...
        e.preventDefault();
          ...
          $.ajax({
            type    : 'POST',
            data    : {no_ktp:no_ktp},
            url     : "bidan_data_kohort/cari_no_ktp",
            dataType: "json",
            success : function(data) {
    ...
    function cari_data(){
      ...
      $.ajax({
        ...
        url     : "bidan_data_kohort/cari_kohort",
        dataType: "json",
        success : function(data) {
