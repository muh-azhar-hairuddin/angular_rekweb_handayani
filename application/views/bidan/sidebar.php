	<div class="left-side-bar">
		<div class="brand-logo">
			...
			<p class="text-center text-muted">Bidan</p>
		</div>
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<li>
						<a href="#" onclick="loadPage('bidan_data_pasien');" class="dropdown-toggle no-arrow">
							<span class="fa fa-users"></span><span class="mtext">Data Pasien</span>
						</a>
					</li>
					<li>
						<a href="#" onclick="loadPage('bidan_data_kohort');" class="dropdown-toggle no-arrow">
