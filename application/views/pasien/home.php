...
<body>
	<?php $this->load->view('pasien/header'); ?>
  <?php $this->load->view('pasien/sidebar'); ?>
	<div class="main-container">

    <div id="loading"></div>
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
      <div id="content"></div>
      <?php $this->load->view('pasien/footer'); ?>
    </div>

	</div>
  <?php $this->load->view('pasien/script'); ?>
  <script>
  $('document').ready(function(){
    loadPage('pasien_data_kohort')
  });
  </script>
</body>
</html>
