...
<body>
	<?php $this->load->view('kepala/header'); ?>
  <?php $this->load->view('kepala/sidebar'); ?>
	<div class="main-container">

    <div id="loading"></div>
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
      <div id="content"></div>
      <?php $this->load->view('kepala/footer'); ?>
    </div>

	</div>
  <?php $this->load->view('kepala/script'); ?>
  <script>
