		...
		public function index()
			{
				...
				if($cek=='login' && $level=='a'){
						$this->load->view('admin/data_pasien/view');
				}else {
															...
															<div class="dropdown">
																...
																<div class="dropdown-menu dropdown-menu-right">
																  <a class="dropdown-item edit" href="#"  data-id="'.$dt->id.'" data-toggle="modal" data-target="#modal-tambah"><i class="fa fa-pencil"></i> Edit</a>
																	<a class="dropdown-item account" href="#"  data-id="'.$dt->id.'" data-toggle="modal" data-target="#modal-account"><i class="fa fa-key"></i> Account</a>
																	<a class="dropdown-item hapus" href="#" data-id="'.$dt->id.'"><i class="fa fa-trash"></i> Delete</a>
																</div>
															</div>
													</center>';
